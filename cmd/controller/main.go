...
import (
	...
	svctypes "github.com/aws-controllers-k8s/bedrockagent-controller/apis/v1alpha1"
...
var (
	awsServiceAPIGroup = "bedrockagent.services.k8s.aws"
	awsServiceAlias    = "bedrockagent"
