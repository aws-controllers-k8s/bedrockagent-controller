...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.AgentID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["agentID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: agentID"))
	}
	r.ko.Status.AgentID = &tmp
