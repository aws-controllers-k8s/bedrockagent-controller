...
const (
	FinalizerString = "finalizers.bedrockagent.services.k8s.aws/Agent"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("agents")
