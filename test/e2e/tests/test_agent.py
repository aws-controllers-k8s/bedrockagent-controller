...
def simple_agent():
    ...
    agent_instruction = "You are a helpful assistant that provides information about AWS services."
    agent_model = "arn:aws:bedrock:us-west-2:807147659905:inference-profile/us.amazon.nova-lite-v1:0"
