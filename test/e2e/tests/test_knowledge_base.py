...
def simple_knowledge_base():
    ...
    vector_store = get_bootstrap_resources().KnowledgeBaseVectorStore
    ...
    replacements["KNOWLEDGE_BASE_ROLE_ARN"] = vector_store.role.arn
    replacements["EMBEDDING_MODEL_ARN"] = vector_store.embedding_model_arn
    replacements["OPENSEARCH_COLLECTION_ARN"] = vector_store.collection_arn
    replacements["VECTOR_INDEX_NAME"] = vector_store.index_name
    replacements["TAG_KEY_1"] = "test1"
    replacements["TAG_VALUE_1"] = "value1"
    ...
    logger.info("KnowledgeBase %s exists in Bedrock", knowledge_base_name)
